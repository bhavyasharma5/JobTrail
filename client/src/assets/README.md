...
const Landing = () => {
  return (
    <StyledWrapper>
      <nav>
        <img src={logo} alt='jobtrail' className='logo' />
      </nav>
...
const Logo = () => {
  return <img src={logo} alt='jobtrail' className='logo' />;
};
